...
for yr in np.arange(1961,2051,1):
    ...
    crfile_dir = r'G:\My Drive\N_deposition_project\Gridded DATA\Data_Organization\Modified_Raster_Files\Cropland_HYDE'
...
for co in range(0,len(shapefile['CNTRY_NAME'])):
    ...
    plt.ylim([0,20])
    plt.savefig(r"D:\GoogleDrive\N_deposition_project\Gridded DATA\Data_Organization\Results\Time_Series_1961_2050\TotNdep_{0}_kgNha.png".format(shapefile['CNTRY_NAME'][co]), dpi=200)

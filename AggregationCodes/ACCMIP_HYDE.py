...
for yr in np.arange(1961,2051,1):
    ...
    # NHx
    file_dir = r'.n\Modified_Raster_Files\Ndep_ACCMIP'
...
for co in range(0,len(shapefile['CNTRY_NAME'])):
    ...
    plt.ylim([0,20])
    plt.savefig(r".\Results\Time_Series_1961_2050\TotNdep_{0}_kgNha.png".format(shapefile['CNTRY_NAME'][co]), dpi=200)
